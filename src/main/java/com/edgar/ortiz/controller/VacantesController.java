...
import com.edgar.ortiz.service.IntCategoriasService;
import com.edgar.ortiz.service.IntVacantesService;
import com.edgar.ortiz.util.Utileria;
...
public class VacantesController {
	...
	public String eliminar(@RequestParam("id") int idVacante, RedirectAttributes atributo) {
		...
		atributo.addFlashAttribute("msg", "Vacante eliminado");
	...
	public String guardarVacante(@Valid Vacante vacante, BindingResult resultado,
		...
		//Obtener la categoría mediante el idCategoria
	...
	/*
	 * Para cuando tenemos datos comunes en todo el controlador a tra vés de los métodos definidos,
	 * y se vincula de forma automática el controlador con la vista.
